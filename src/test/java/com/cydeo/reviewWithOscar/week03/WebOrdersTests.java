...
locate all checkBoxes: I need to find a locator which will show(point) all the checkboxes, after this step I can use findElements() method for multiple WebElements
    ...
    // After we delete, we can get all the names of the customers as a List,
    // then verify that deleted name is NOT in the list
        ...
        for (WebElement namesElement : namesElements) {
            // verify each element text that it does not contain deleted person
