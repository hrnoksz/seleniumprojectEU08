...
public class PolymerTest {
     ...
     */
    static WebDriver driver;  // when we declare a variable outside main method, it becomes global variable,
    // so it can be usable at other methods inside class
    public static void main(String[] args) {

        // The first step should be to load the website
        // From Selenium Library (Version 3 - pom.xml: dependency) we use WebDriver Interface,
        // and with a polymorphic way we create driver instance
